...
export class ActionUtils {
   ...
   */
  static async pressEnter(input: string | Locator, options: any = {}): Promise<void> {
    this.logger.info('Press Enter');
    this.allureReporter.addStep('Press Enter');
    const locator = await this.getLocatorWithStableAndVisibleOptions(input, options);
    await locator.press('Enter');
  }
   ...
   */
  static async pressTab(input: string | Locator, options: any = {}): Promise<void> {
    this.logger.info('Press Tab');
    this.allureReporter.addStep('Press Tab');
    const locator = await this.getLocatorWithStableAndVisibleOptions(input, options);
    await locator.press('Tab');
  }
   ...
   */
  static async pressEscape(input: string | Locator, options: any = {}): Promise<void> {
    this.logger.info('Press Escape');
    this.allureReporter.addStep('Press Escape');
    const locator = await this.getLocatorWithStableAndVisibleOptions(input, options);
    await locator.press('Escape');
  }

  /**
   * Press Space key on element
   */
  static async pressSpace(input: string | Locator, options: any = {}): Promise<void> {
    this.logger.info('Press Space');
    this.allureReporter.addStep('Press Space');
    const locator = await this.getLocatorWithStableAndVisibleOptions(input, options);
    await locator.press(' ');
  }

  /**
   * Press any key on element
   */
  static async pressKey(input: string | Locator, key: string, options: any = {}): Promise<void> {
    this.logger.info(`Press key: ${key}`);
    this.allureReporter.addStep(`Press key: ${key}`);
    const locator = await this.getLocatorWithStableAndVisibleOptions(input, options);
  ...
  static async triggerEvent(
    ...
    await locator.evaluate(
      (el: HTMLElement, args: { type: string; data: any }) => {
