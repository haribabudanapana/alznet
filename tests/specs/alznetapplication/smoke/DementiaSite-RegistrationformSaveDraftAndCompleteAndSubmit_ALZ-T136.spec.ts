...
import testData from '@data/Staging/alznetapplication/smoke/ALZ-T136.json' with { type: 'json' };
...
test.describe('Dementia Site - Registration form Save Draft, Complete & Submit.', () => {
